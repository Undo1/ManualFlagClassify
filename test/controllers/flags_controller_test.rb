...
class FlagsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create flag" do
    assert_difference('Flag.count') do
      post flags_url, params: { flag: { flag_text: @flag.flag_text, result: @flag.result, result_reason: @flag.result_reason } }
    end
  ...
  test "should update flag" do
    patch flag_url(@flag), params: { flag: { flag_text: @flag.flag_text, result: @flag.result, result_reason: @flag.result_reason } }
